...
namespace Jitter.Collision.Shapes
{
    ...
    {
        private sfloat radius = sfloat.One;
        ...
        {
            mass = ((sfloat)4.0f / (sfloat)3.0f) * JMath.Pi * radius * radius * radius;

            // (0,0,0) is the center of mass, so only
            // the main matrix elements are != 0
            inertia = JMatrix.Identity;
            inertia.M11 = (sfloat)0.4f * this.mass * radius * radius;
            inertia.M22 = (sfloat)0.4f * this.mass * radius * radius;
            inertia.M33 = (sfloat)0.4f * this.mass * radius * radius;
        }
