...
namespace BEPUutilities
{
    ...
    public struct Vector4 : IEquatable<Vector4>
    {
        ...
        public Vector4(fint x, fint y, fint z, fint w)
        {
            this.X = x;
            this.Y = y;
            this.Z = z;
        ...
        /// <param name="w">W component of the vector.</param>
        public Vector4(Vector3 xyz, fint w)
        {
            this.X = xyz.X;
            this.Y = xyz.Y;
            this.Z = xyz.Z;
        ...
        public Vector4(fint x, Vector3 yzw)
        {
            this.X = x;
            this.Y = yzw.X;
            this.Z = yzw.Y;
        ...
        /// <param name="z">Z component of the vector.</param>
        /// <param name="w">W component of the vector.</param>
        public Vector4(Vector2 xy, fint z, fint w)
        {
            this.X = xy.X;
            this.Y = xy.Y;
            this.Z = z;
        ...
        /// <param name="w">W component of the vector.</param>
        public Vector4(fint x, Vector2 yz, fint w)
        {
            this.X = x;
            this.Y = yz.X;
            this.Z = yz.Y;
        ...
        public Vector4(fint x, fint y, Vector2 zw)
        {
            this.X = x;
            this.Y = y;
            this.Z = zw.X;
        ...
        {
            fint inverse = (1 / fint.Sqrt(X * X + Y * Y + Z * Z + W * W));
            X *= inverse;
            Y *= inverse;
            Z *= inverse;
            W *= inverse;
        ...
        public static fint Dot(Vector4 a, Vector4 b)
        {
        ...
        public static void Dot(ref Vector4 a, ref Vector4 b, out fint product)
        {
        ...
        public static void Multiply(ref Vector4 v, fint scale, out Vector4 result)
        {
            result.X = v.X * scale;
            result.Y = v.Y * scale;
            result.Z = v.Z * scale;
        ...
        public static void Divide(ref Vector4 v, fint divisor, out Vector4 result)
        {
        ...
        public static Vector4 operator *(Vector4 v, fint f)
        {
            Vector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        /// <param name="f">Amount to scale.</param>
        /// <returns>Scaled vector.</returns>
        public static Vector4 operator *(fint f, Vector4 v)
        {
            Vector4 toReturn;
            toReturn.X = v.X * f;
            toReturn.Y = v.Y * f;
        ...
        public static void DistanceSquared(ref Vector4 a, ref Vector4 b, out fint distanceSquared)
        {
            fint x = a.X - b.X;
            fint y = a.Y - b.Y;
            fint z = a.Z - b.Z;
        ...
        public static void Distance(ref Vector4 a, ref Vector4 b, out fint distance)
        {
            fint x = a.X - b.X;
            fint y = a.Y - b.Y;
            fint z = a.Z - b.Z;
            fint w = a.W - b.W;
            distance = fint.Sqrt(x * x + y * y + z * z + w * w);
        }
        /// <summary>
        /// Computes the distance between two two vectors.
        /// </summary>
        ...
        public static fint Distance(Vector4 a, Vector4 b)
        {
            fint toReturn;
        ...
        {
            fint inverse = (fint)(1 / fint.Sqrt(v.X * v.X + v.Y * v.Y + v.Z * v.Z + v.W * v.W));
            result.X = v.X * inverse;
            result.Y = v.Y * inverse;
            result.Z = v.Z * inverse;
            result.W = v.W * inverse;
        ...
        public static Vector4 Lerp(Vector4 start, Vector4 end, fint interpolationAmount)
        {
            Vector4 toReturn;
        ...
        public static void Lerp(ref Vector4 start, ref Vector4 end, fint interpolationAmount, out Vector4 result)
        {
            fint startAmount = 1 - interpolationAmount;
        ...
        /// <param name="result">Interpolated intermediate state.</param>
        public static void Hermite(ref Vector4 value1, ref Vector4 tangent1, ref Vector4 value2, ref Vector4 tangent2, fint interpolationAmount, out Vector4 result)
        {
        ...
        /// <param name="interpolationAmount">Amount of the second point to use.</param>
        /// <returns>Interpolated intermediate state.</returns>
        public static Vector4 Hermite(Vector4 value1, Vector4 tangent1, Vector4 value2, Vector4 tangent2, fint interpolationAmount)
        {
            Vector4 toReturn;
