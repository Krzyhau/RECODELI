...
namespace BEPUphysics
{
    ...
    public class Space
    {
        ...
        public sfloat Time
        {
            get { return (end - start) / (sfloat)Stopwatch.Frequency; }
        }
        ...
        {
            return RayCast(ray, sfloat.MaxValue, out result);
        }
        ...
        {
            return RayCast(ray, sfloat.MaxValue, filter, out result);
        }
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, sfloat maximumLength, out RayCastResult result)
        {
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, sfloat maximumLength, Func<BroadPhaseEntry, bool> filter, out RayCastResult result)
        {
            var resultsList = PhysicsResources.GetRayCastResultList();
        ...
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, sfloat maximumLength, IList<RayCastResult> outputRayCastResults)
        {
        ...
        /// <param name="outputRayCastResults">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, sfloat maximumLength, Func<BroadPhaseEntry, bool> filter, IList<RayCastResult> outputRayCastResults)
        {
            var outputIntersections = PhysicsResources.GetBroadPhaseEntryList();
            if (BroadPhase.QueryAccelerator.RayCast(ray, maximumLength, outputIntersections))
            {
