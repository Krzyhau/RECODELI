...
namespace BEPUphysics
{
    ...
    public class Space
    {
        ...
        {
            return RayCast(ray, fint.MaxValue, out result);
        }
        ...
        {
            return RayCast(ray, fint.MaxValue, filter, out result);
        }
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, fint maximumLength, out RayCastResult result)
        {
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, fint maximumLength, Func<BroadPhaseEntry, bool> filter, out RayCastResult result)
        {
            var resultsList = PhysicsResources.GetRayCastResultList();
        ...
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, fint maximumLength, IList<RayCastResult> outputRayCastResults)
        {
        ...
        /// <param name="outputRayCastResults">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray ray, fint maximumLength, Func<BroadPhaseEntry, bool> filter, IList<RayCastResult> outputRayCastResults)
        {
            var outputIntersections = PhysicsResources.GetBroadPhaseEntryList();
            if (BroadPhase.QueryAccelerator.RayCast(ray, maximumLength, outputIntersections))
            {
