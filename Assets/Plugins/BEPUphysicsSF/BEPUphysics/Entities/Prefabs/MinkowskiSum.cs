...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MinkowskiSum : Entity<ConvexCollidable<MinkowskiSumShape>>
    {
        ...
        private MinkowskiSum(OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, fint m)
        ...
        public MinkowskiSum(Vector3 position, OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, fint mass)
            : this(a, b, mass)
        {
            Position = position;
        }
        ...
        /// <param name="b">Second entity in the sum.</param>
        /// <param name="mass">Mass of the object.</param>
        public MinkowskiSum(MotionState motionState, OrientedConvexShapeEntry a, OrientedConvexShapeEntry b, fint mass)
            : this(a, b, mass)
        {
        ...
        /// <param name="mass">Mass of the object.</param>
        public MinkowskiSum(MotionState motionState, IList<OrientedConvexShapeEntry> shapes, fint mass)
