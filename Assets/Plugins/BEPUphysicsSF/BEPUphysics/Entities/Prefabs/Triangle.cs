...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        public Triangle(Vector3 v1, Vector3 v2, Vector3 v3, fint mass)
        {
            Vector3 center;
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(Vector3 pos, Vector3 v1, Vector3 v2, Vector3 v3, fint mass)
            : this(v1, v2, v3, mass)
        {
            Position = pos;
        }
        ...
        /// <param name="v3">Position of the third vertex.</param>
        /// <param name="mass">Mass of the object.</param>
        public Triangle(MotionState motionState, Vector3 v1, Vector3 v2, Vector3 v3, fint mass)
            : this(v1, v2, v3, mass)
        {
