    ...
    public static class MPRToolbox
    {
        ...
        public static void LocalSurfaceCast(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref Vector3 direction, out fint t, out Vector3 normal)
        {
            ...
            while (true)
            {
                ...
                {
                    //normal = n;
                    //sfloat normalLengthInverse = 1 / normal.Length();
        ...
        internal static void GetLocalPosition(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform localTransformB, ref Vector3 minkowskiPosition, out Vector3 position)
        {
            ...
            while (true)
            {
                ...
                //    {
                //        sfloat inverseTotalVolume = 1 / v0v1v2v3volume;
                ...
                //        sfloat v3Weight = 1 - v0Weight - v1Weight - v2Weight;
                //        position = v1Weight * v1A + v2Weight * v2A + v3Weight * v3A;
                //    }
                //    else
                //    {
                ...
                //if (dot2 < sfloat.Zero) //We're not concerned with this test!  We already have guarantees that the shape contains or very nearly contains the minkowski point.
                //{
                //    //The origin is outside!
                //    position = new Vector3();
                //    return false;
