    ...
    public class MobileMeshCollidable : EntityCollidable
    {
        ...
        public override bool RayCast(Ray ray, sfloat maximumLength, out RayHit rayHit)
        {
            ...
            if (Shape.solidity == MobileMeshSolidity.Solid)
            {
                ...
                {
                    //It was inside!
                    rayHit = new RayHit() { Location = ray.Position, Normal = Vector3.Zero, T = sfloat.Zero };
                    return true;
                ...
                else
                {
                    ...
                    {
                        //The hit was too far away, or there was no hit (in which case T would be sfloat.MaxValue).
                        return false;
                    }
                    return true;
                }
        ...
        public override bool ConvexCast(ConvexShape castShape, ref RigidTransform startingTransform, ref Vector3 sweep, out RayHit hit)
        {
            if (Shape.solidity == MobileMeshSolidity.Solid)
            {
                ...
                if (Shape.IsLocalRayOriginInMesh(ref ray, out hit))
                {
                    ...
                    hit = new RayHit() { Location = startingTransform.Position, Normal = new Vector3(), T = sfloat.Zero };
                    return true;
                }
            }
            hit = new RayHit();
