...
namespace BEPUphysics.Vehicle
{
    ...
    public class WheelSlidingFriction : ISolverSettings
    {
        ...
        private sfloat kineticCoefficient;
        ...
        private sfloat staticCoefficient;
        private sfloat staticFrictionVelocityThreshold = (sfloat)5;
        private Wheel wheel;
        ...
        public WheelSlidingFriction(sfloat dynamicCoefficient, sfloat staticCoefficient)
        {
        ...
        /// </summary>
        public sfloat KineticCoefficient
        {
            get { return kineticCoefficient; }
            set { kineticCoefficient = MathHelper.Max(value, sfloat.Zero); }
        }
        ...
        /// taken into account to determine the used coefficient at any given time.
        /// </summary>
        public sfloat StaticCoefficient
        {
            get { return staticCoefficient; }
            set { staticCoefficient = MathHelper.Max(value, sfloat.Zero); }
        }
        ...
        internal void PreStep(sfloat dt)
        {
            ...
            sfloat axisLength = slidingFrictionAxis.LengthSquared();
