...
namespace BEPUphysics.Vehicle
{
    ...
    {
        private sfloat graphicalRadius;
        ...
        public RaycastWheelShape(sfloat graphicalRadius, Matrix localGraphicTransform)
        {
        ...
        public override sealed sfloat Radius
        {
            ...
            set
            {
                graphicalRadius = sfloat.Max(value, sfloat.Zero);
                Initialize();
            }
        }
        ...
        public override void UpdateWorldTransform()
        {
            ...
            sfloat length = wheel.suspension.currentLength - graphicalRadius;
