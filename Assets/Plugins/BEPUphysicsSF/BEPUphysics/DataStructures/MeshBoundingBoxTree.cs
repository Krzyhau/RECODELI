...
namespace BEPUphysics.DataStructures
{
    ...
    public class MeshBoundingBoxTree
    {
        ...
        public bool GetOverlaps(Ray ray, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                ...
                if (ray.Intersects(ref root.BoundingBox, out result))
                    root.GetOverlaps(ref ray, fint.MaxValue, outputOverlappedElements);
            }
            return outputOverlappedElements.Count > 0;
        }
        /// <summary>
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(Ray ray, fint maximumLength, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                fint result;
        ...
        abstract class Node
        {
            ...
            internal abstract void GetOverlaps(ref Ray ray, fint maximumLength, IList<int> outputOverlappedElements);
        ...
        sealed class InternalNode : Node
        {
            ...
            internal override void GetOverlaps(ref Ray ray, fint maximumLength, IList<int> outputOverlappedElements)
            {
                fint result;
        ...
        /// </summary>
        public static fint LeafMargin = (fint).001f;
